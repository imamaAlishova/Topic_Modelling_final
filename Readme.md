...
Based on the LDA topic modeling results provided, there seems to be a lot of overlaps with the selected articles.
...
The remaining topics may not have been mentioned in the articles, or the raw materials may have touched upon these topics but not in the same context as suggested by the LDA topic modeling results.
